        ...
        IntrinsicHeight(
          child: Row(
            ...
            children: [
              ...
              Expanded(
                  child: Text(AppLocalizations.of(context)!.numbers_of_ayat,
                      textAlign: TextAlign.center,
                      style: Theme.of(context).textTheme.bodyLarge))
            ],
          ),
                    ...
                    return IntrinsicHeight(
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                              child: Text('${numberOfAyahs[index]}',
                                  textAlign: TextAlign.center,
                                  style:
...
class SuraArgs {
  ...
  String title;
  List<String> content;
  SuraArgs({required this.title, required this.content, required this.index});
}
